...
//TODO: Edit to numbers for your architecture (AMD/ARM)
#define SYS_array_init       #
#define SYS_array_cleanup    #
#define SYS_producer_function #
#define SYS_consumer_function #
#define SYS_auditor_function  #
